...
class Ui_GenerateNeodenConfigDialog(object):
    def setupUi(self, GenerateNeodenConfigDialog):
        ...
        GenerateNeodenConfigDialog.resize(1024, 768)
        GenerateNeodenConfigDialog.setMinimumSize(QtCore.QSize(1024, 768))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(0, 730, 1021, 31))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 50, 1021, 681))
        ...
        self.tableTopComponents.setGeometry(QtCore.QRect(0, 0, 1011, 651))
        ...
        self.tableTopComponents.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableTopComponents.setItem(0, 0, item)
        ...
        self.tableBottomComponents.setGeometry(QtCore.QRect(0, 0, 1011, 651))
        self.tableBottomComponents.setObjectName("tableBottomComponents")
        self.tableBottomComponents.setColumnCount(10)
        self.tableBottomComponents.setRowCount(1)
        item = QtWidgets.QTableWidgetItem()
        self.tableBottomComponents.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableBottomComponents.setItem(0, 0, item)
    ...
    def retranslateUi(self, GenerateNeodenConfigDialog):
        ...
        item = self.tableTopComponents.verticalHeaderItem(0)
        item.setText(_translate("GenerateNeodenConfigDialog", "0"))
        ...
        item.setText(_translate("GenerateNeodenConfigDialog", "X Submodules"))
        ...
        item.setText(_translate("GenerateNeodenConfigDialog", "Y Submodules"))
        ...
        __sortingEnabled = self.tableTopComponents.isSortingEnabled()
        self.tableTopComponents.setSortingEnabled(False)
        self.tableTopComponents.setSortingEnabled(__sortingEnabled)
        ...
        item = self.tableBottomComponents.verticalHeaderItem(0)
        item.setText(_translate("GenerateNeodenConfigDialog", "0"))
        ...
        item.setToolTip(_translate("GenerateNeodenConfigDialog", "<html><head/><body><p>Display &quot;Yes&quot; if component needs to be skipped during the pick&amp;place proccess.</p><p>Select &quot;Yes&quot; if the component needs to be skipped or</p><p>select &quot;No&quot; if the component does not need to be skipped.</p><p>Default value = &quot;No&quot;</p></body></html>"))
        item.setWhatsThis(_translate("GenerateNeodenConfigDialog", "<html><head/><body><p>Display &quot;Yes&quot; if component needs to be skipped during the pick&amp;place proccess.</p><p>Select &quot;Yes&quot; if the component needs to be skipped or</p><p>select &quot;No&quot; if the component does not need to be skipped.</p><p>Default value = &quot;No&quot;</p></body></html>"))
        __sortingEnabled = self.tableBottomComponents.isSortingEnabled()
        self.tableBottomComponents.setSortingEnabled(False)
        self.tableBottomComponents.setSortingEnabled(__sortingEnabled)
